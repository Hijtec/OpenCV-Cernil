...
while True:
    ___, frame1 = cap1.read();
    ___, frame2 = cap2.read();
    ...
    while savedMeanDelta_stop == 0:
        ...
        savedMeanDelta_stop, savedMeanDispmap_stop = calibrate2safedistance(frameDeltaROI, dispmapROI);
