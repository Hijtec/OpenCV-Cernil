import numpy as np
import cv2
from BP_scripts.functions import Release, Calibrate2Cameras

imgsize, leftMapX, leftMapY, leftROI, rightMapX, rightMapY, rightROI, frame, frame2 = Calibrate2Cameras(0,1)# calibrates camera 0 and returns its feed, matrix and distortions and other things, see functions for more info
